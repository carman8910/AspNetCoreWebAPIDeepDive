...
namespace CourseLibrary.API.ActionConstraints
{
    ...
    public class RequestHeadersMatchesMediaTypeAttribute : Attribute, IActionConstraint
    {
        private readonly string _requestHeaderToMatch;
        private readonly MediaTypeCollection mediaTypes = new();

        public RequestHeadersMatchesMediaTypeAttribute(
            ...
            params string[] otherMediaTypes)
        {
            ...
            // and add them to the _meadiaTypes collection
